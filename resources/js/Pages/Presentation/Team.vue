            ...
            <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 place-items-center">
                ...
                <div class="group">
                    <div class="team_img rounded-lg overflow-hidden relative">
                        <img loading="lazy" src="assets/images/team-1.jpg" class="h-auto w-80 rounded-lg" alt="team">
                        <div
                            class="flex items-center gap-2 absolute left-1/2 -translate-x-1/2 bottom-0 opacity-0 group-hover:opacity-100 group-hover:bottom-[16px] transition-all duration-300 z-10">
                            <a href="#"
                                class="w-6 h-6 bg-[#3B5998] text-white rounded-sm flex justify-center items-center">
                            ...
                            <a href="#"
                                class="w-6 h-6 bg-[#0a58ca] text-white rounded-sm flex justify-center items-center">
                            ...
                            <a href="#"
                                class="w-6 h-6 bg-[#D53982] text-white rounded-sm flex justify-center items-center">
                                <svg width="16" height="16" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                ...
                <div class="group">
                    <div class="team_img rounded-lg overflow-hidden relative">
                        <img loading="lazy" src="assets/images/team-2.jpg" class="h-auto w-80 rounded-lg" alt="team">
                        <div
                            class="flex items-center gap-2 absolute left-1/2 -translate-x-1/2 bottom-0 opacity-0 group-hover:opacity-100 group-hover:bottom-[16px] transition-all duration-300 z-10">
                            <a href="#"
                                class="w-6 h-6 bg-[#3B5998] text-white rounded-sm flex justify-center items-center">
                ...
                <div class="group">
                    <div class="team_img rounded-lg overflow-hidden relative">
                        <img loading="lazy" src="assets/images/team-4.jpg" class="h-auto w-80 rounded-lg" alt="team">
                        <div
                            class="flex items-center gap-2 absolute left-1/2 -translate-x-1/2 bottom-0 opacity-0 group-hover:opacity-100 group-hover:bottom-[16px] transition-all duration-300 z-10">
                            <a href="#"
                                class="w-6 h-6 bg-[#3B5998] text-white rounded-sm flex justify-center items-center">
                ...
                <div class="group">
                    <div class="team_img rounded-lg overflow-hidden relative">
                        <img loading="lazy" src="assets/images/team-3.jpg" class="h-auto w-80 rounded-lg" alt="team">
                        <div
                            class="flex items-center gap-2 absolute left-1/2 -translate-x-1/2 bottom-0 opacity-0 group-hover:opacity-100 group-hover:bottom-[16px] transition-all duration-300 z-10">
                            <a href="#"
                                class="w-6 h-6 bg-[#3B5998] text-white rounded-sm flex justify-center items-center">
