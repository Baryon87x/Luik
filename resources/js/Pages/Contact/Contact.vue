    ...
    <section class="container mx-auto p-5">
        <div class="grid grid-cols-12 gap-6 w-full">
            <div class="col-span-12 lg:col-span-7 bg-white box_shadow px-[30px] py-[24px]">
                <div>
                        <h4 class="text-[20px] sm:text-[28px] uppercase mb-1">Laissez-nous un message</h4>
                        <p class="mb-6 text-[15px]">Utilisez le formulaire ci-dessous pour prendre contact avec l'équipe de vente</p>
                        <div class="grid grid-cols-12 gap-5">
                            <div class="col-span-12 sm:col-span-6">
                                <div>
                                    <label for="first_name" class="block mb-1.5">Prénom <span
                                            class="text-[#fd3d57ad]">*</span></label>
                                    <input type="text"
                                        class="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0">
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <div class="single_billing_inp">
                                    <label for="last_name" class="block mb-1.5">Nom <span
                                            class="text-[#fd3d57ad]">*</span></label>
                                    <input type="text"
                                        class="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0">
                                </div>
                            ...
                            <div class="col-span-12">
                                <div class="single_billing_inp">
                                    <label for="email_addr" class="block mb-1.5">Adresse e-mail <span
                                            class="text-[#fd3d57ad]">*</span></label>
                                    <input type="text"
                                        class="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0">
                                </div>
                            ...
                            <div class="col-span-12">
                                <div class="single_billing_inp">
                                    <label for="company_name" class="block mb-1.5">Sujet</label>
                                    <input type="text"
                                        class="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0">
                                </div>
                            </div>
                            <div class="col-span-12">
                                <div class="single_billing_inp">
                                    <label for="county_region" class="block mb-1.5">Votre message <span
                                            class="text-[#fd3d57ad]">*</span></label>
                                    <textarea type="text"
                                        class="w-full border border-[#E9E4E4] rounded focus:border-[#fd3d57ad] focus:ring-0"></textarea>
                                </div>
                            </div>
                            <div class="col-span-12 mt-4">
                                <button type="submit" class="bg-slate-900 text-white rounded py-3 px-5">envoyer un message</button>
                            </div>
                    ...
                    <div class="col-span-12 lg:col-span-5 bg-white box_shadow px-[30px] py-[24px]">
                        ...
                        <h4 class="text-[18px] uppercase mb-[14px]">notre magasin</h4>
                        <div class="footer_contact">
                            ...
                            <div class="relative pb-3">
                                ...
                                <p class="pl-[32px]">+566 477 256, +566 254 575</p>
                            </div>
                            <div class="relative pb-3">
                                <span class="absolute left-0 top-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                ...
                                <p class="pl-[32px]"> info@domain.com</p>
                            </div>
                        </div>
                        ...
                        <h4 class="text-lg mt-4 mb-3 uppercase">Carrières</h4>
                        <p class="text_md mb-0">Si vous êtes intéressant dans l'emploi <br> Opportunités à Rafcarts. S'il te plaît
